...
syn region perlQW		matchgroup=perlQWStartEnd start=+\<\%(::\|'\|->\)\@<!qw\s*\z([^[:space:]#([{<]\)+  end=+\z1+ contains=@perlInterpQW keepend
syn region perlQW		matchgroup=perlQWStartEnd start=+\<\%(::\|'\|->\)\@<!qw#+  end=+#+ contains=@perlInterpQW keepend
syn region perlQW		matchgroup=perlQWStartEnd start=+\<\%(::\|'\|->\)\@<!qw\s*(+  end=+)+ contains=@perlInterpQW keepend
syn region perlQW		matchgroup=perlQWStartEnd start=+\<\%(::\|'\|->\)\@<!qw\s*\[+  end=+\]+ contains=@perlInterpQW keepend
syn region perlQW		matchgroup=perlQWStartEnd start=+\<\%(::\|'\|->\)\@<!qw\s*{+  end=+}+ contains=@perlInterpQW keepend
syn region perlQW		matchgroup=perlQWStartEnd start=+\<\%(::\|'\|->\)\@<!qw\s*<+  end=+>+ contains=@perlInterpQW keepend
...
" a string
" JH changed to 'perlBareword'
syn match  perlBareword "\I\@<!-\?\I\i*\%(\s*=>\)\@="
...
HiLink perlPackageDecl		perlBareword
...
" ??
HiLink perlInterpQW perlBareword
